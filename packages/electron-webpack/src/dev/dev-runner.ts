...
import webpack, { Compiler, type Watching } from "webpack"
...
class DevRunner {
  ...
  async startMainCompilation(hmrServer: HmrServer) {
    ...
    await new Promise((resolve: ((value: void | PromiseLike<void>) => void) | null, reject: ((reason?: any) => void) | null) => {
      ...
      let watcher: Watching | null = compiler.watch({}, (error, stats) => {
        ...
        hmrServer.built(stats as webpack.Stats)
      })
